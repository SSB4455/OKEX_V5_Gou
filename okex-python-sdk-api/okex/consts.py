...
# account
WALLET_INFO = '/api/v5/account/balance'
CURRENCY_INFO = '/api/v5/account/balance'
...
COIN_TOP_UP_RECORDS = '/api/v5/asset/deposit-history'
COIN_TOP_UP_RECORD = '/api/v5/asset/deposit-history'
...
SPOT_TICKER = '/api/v5/market/tickers'
SPOT_SPECIFIC_TICKER = '/api/v5/market/ticker'
...
LEVER_ORDER = '/api/v5/trade/order'
...
LEVER_CLOSE_POSITION = '/api/v5/trade/close-position'
LEVER_SET_LEVERAGE = '/api/v5/account/set-leverage'
